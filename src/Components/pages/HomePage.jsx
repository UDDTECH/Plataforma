...
function HomePage() {
  return (
    <main className="flex flex-col items-center justify-center bg-gradient-to-br from-header/70 via-header/40 to-header/10">
      ...
      <div className="flex flex-col text-center items-center my-10 gap-3 p-1 py-5 gap-y-10 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-10 mt-5 w-11/12 items-center justify-center">
          <Card.Root className=" relative flex flex-col bg-slate-900 gap-y-3 w-full max-w-[300px] min-w-[250px] md:min-w-[210px] mx-auto shadow-sm shadow-white">
          ...
          <Card.Root className=" relative flex flex-col bg-slate-900 gap-y-3 w-full max-w-[300px] min-w-[200px] md:min-w-[210px] mx-auto shadow-sm shadow-white">
            <span className="absolute m-2 z-10 right-0 text-end bg-slate-200/30 p-1 rounded-2xl">
              7 min
            </span>
            <img
